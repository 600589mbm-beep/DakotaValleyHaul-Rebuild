...
export const counties = {
  'hennepin-county': {
    ...
    metaDescription: "Curbside and garage junk removal across Hennepin County — Minneapolis, Bloomington, Edina, Eden Prairie, Plymouth, and more. an $85 pickup minimum, photo quotes.",
  },
  'ramsey-county': {
    name: 'Ramsey County',
    slug: 'ramsey-county',
    ...
    metaDescription: "Curbside and garage junk removal across Ramsey County — St. Paul, Roseville, Maplewood, White Bear Lake, Shoreview. an $85 pickup minimum, photo quotes.",
  },
  'dakota-county': {
    name: 'Dakota County',
    slug: 'dakota-county',
    ...
    seat: 'Hastings',
    intro:
      "Dakota County is Dakota Valley's home county. The densest route coverage we have. Appointment-based curbside and garage junk pickup throughout Apple Valley, Eagan, Burnsville, Lakeville, Rosemount, Farmington, Hastings, Inver Grove Heights, and surrounding cities.",
    cities: ['Apple Valley', 'Eagan', 'Burnsville', 'Lakeville', 'Rosemount', 'Farmington', 'Hastings', 'Inver Grove Heights'],
    metaTitle: "Junk Removal Dakota County MN | Written Photo Quotes | Dakota Valley",
    metaDescription: "Curbside and garage junk removal across Dakota County — Apple Valley, Eagan, Burnsville, Lakeville, Rosemount, Farmington, Hastings. Pickup windows confirmed by the crew. Loads from $85.",
  },
  'anoka-county': {
    name: 'Anoka County',
    slug: 'anoka-county',
    ...
    metaDescription: "Curbside and garage junk removal across Anoka County — Coon Rapids, Blaine, Anoka, Andover, Fridley. an $85 pickup minimum, photo quotes.",
  },
  'washington-county': {
    ...
    metaDescription: "Curbside and garage junk removal across Washington County — Woodbury, Cottage Grove, Stillwater, Oakdale. an $85 pickup minimum, photo quotes.",
  },
  'scott-county': {
    name: 'Scott County',
    slug: 'scott-county',
    ...
    metaDescription: "Curbside and garage junk removal across Scott County — Shakopee, Prior Lake, Savage, Jordan. an $85 pickup minimum, photo quotes.",
  },
  'carver-county': {
    name: 'Carver County',
    slug: 'carver-county',
    ...
    metaDescription: "Curbside and garage junk removal across Carver County — Chaska, Chanhassen, Victoria, Waconia. an $85 pickup minimum, photo quotes.",
  },
  'olmsted-county': {
    name: 'Olmsted County',
    slug: 'olmsted-county',
    ...
    metaDescription: "Curbside and garage junk removal across Olmsted County — Rochester, Byron, Stewartville. an $85 pickup minimum, photo quotes.",
  },
  'st-louis-county': {
    ...
    metaDescription: "Curbside and garage junk removal across St. Louis County — Duluth, Hibbing, Virginia, Hermantown. an $85 pickup minimum, photo quotes.",
  },
  'stearns-county': {
    name: 'Stearns County',
    slug: 'stearns-county',
    ...
    metaDescription: "Curbside and garage junk removal across Stearns County — St. Cloud, Sartell, Sauk Centre. an $85 pickup minimum, photo quotes.",
  },
  'wright-county': {
    name: 'Wright County',
    slug: 'wright-county',
    ...
    metaDescription: "Curbside and garage junk removal across Wright County — Buffalo, Monticello, St. Michael, Albertville. an $85 pickup minimum, photo quotes.",
  },
  'sherburne-county': {
    ...
    metaDescription: "Curbside and garage junk removal across Sherburne County — Elk River, Big Lake, Becker, Princeton. an $85 pickup minimum, photo quotes.",
  },
};
