...
export const counties = {
  'hennepin-county': {
    ...
    metaDescription: 'Curbside and garage junk removal across Hennepin County — Minneapolis, Bloomington, Edina, Eden Prairie, Plymouth, and more. loads from $85, photo quotes.',
  },
  'ramsey-county': {
    name: 'Ramsey County',
    slug: 'ramsey-county',
  ...
  'anoka-county': {
    ...
    metaDescription: 'Curbside and garage junk removal across Anoka County — Coon Rapids, Blaine, Anoka, Andover, Fridley. loads from $85, photo quotes.',
  },
  'washington-county': {
  ...
  'scott-county': {
    ...
    metaDescription: 'Curbside and garage junk removal across Scott County — Shakopee, Prior Lake, Savage, Jordan. loads from $85, photo quotes.',
  },
  'carver-county': {
    name: 'Carver County',
    slug: 'carver-county',
